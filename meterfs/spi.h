...
enum { cmd_wrsr = 0x01, cmd_write, cmd_read, cmd_wrdi, cmd_rdsr, cmd_wren, cmd_hsread = 0x0b, cmd_ewsr = 0x50,
	cmd_sector_erase = 0x52, cmd_chip_erase = 0x60, cmd_ebsy = 0x70, cmd_dbsy = 0x80, cmd_rdid = 0x90,
	cmd_jedecid = 0x9f, cmd_aai_write = 0xad, cmd_block_erase = 0xd8 };
