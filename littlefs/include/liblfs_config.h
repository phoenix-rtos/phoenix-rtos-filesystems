 ...
 * Phoenix-RTOS
 *
 * LittleFS configuration header file.
 *
...
#ifdef NDEBUG
/* Disable assertions (they should not be necessary in production) */
#define LFS_NO_ASSERT
/* Disable debug level prints */
#define LFS_NO_DEBUG
#endif
...
struct lfs_config {
	 ...
	 * Must be at least 4 (lfs_dir_commitcrc makes implicit assumptions about it)
	 */
