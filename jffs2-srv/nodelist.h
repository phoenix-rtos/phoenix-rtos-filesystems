...
static inline struct jffs2_node_frag *frag_first(os_tree_root_t *root)
{
	os_tree_node_t *node = rb_first(root);
...
static inline struct jffs2_node_frag *frag_last(os_tree_root_t *root)
{
	os_tree_node_t *node = rb_last(root);
...
#define frag_left(frag) rb_entry(rb_left(&(frag)->rb), struct jffs2_node_frag, rb)
#define frag_right(frag) rb_entry(rb_right(&(frag)->rb), struct jffs2_node_frag, rb)
...
#define tn_left(tn) rb_entry(rb_left(&(tn)->rb), struct jffs2_tmp_dnode_info, rb)
#define tn_right(tn) rb_entry(rb_right(&(tn)->rb), struct jffs2_tmp_dnode_info, rb)
...
void jffs2_kill_fragtree(os_tree_root_t *root, struct jffs2_sb_info *c_delete);
...
/* write.c */
int jffs2_do_new_inode(struct jffs2_sb_info *c, struct jffs2_inode_info *f, jmode_t mode, uint32_t datasize, struct jffs2_raw_inode *ri);
struct jffs2_full_dnode *jffs2_write_dnode(struct jffs2_sb_info *c, struct jffs2_inode_info *f,
					   struct jffs2_raw_inode *ri, const char *data,
					   uint32_t datalen, int alloc_mode);
struct jffs2_full_dirent *jffs2_write_dirent(struct jffs2_sb_info *c, struct jffs2_inode_info *f,
					     struct jffs2_raw_dirent *rd, const char *name,
					     uint32_t namelen, int alloc_mode);
int jffs2_write_inode_range(struct jffs2_sb_info *c, struct jffs2_inode_info *f, struct jffs2_raw_inode *ri,
				char *buf, uint32_t offset, uint32_t writelen, uint32_t *retlen,
				os_time_t *f_mtime, os_time_t *f_ctime, os_time_t *f_atime);
int jffs2_write0_inode_range(struct jffs2_sb_info *c, struct jffs2_inode_info *f, struct jffs2_raw_inode *ri,
				uint32_t offset, uint32_t writelen);
int jffs2_do_create(struct jffs2_sb_info *c, struct jffs2_inode_info *dir_f, struct jffs2_inode_info *f,
					struct jffs2_raw_inode *ri,
					const char *name, int namelen,
					const char *data, int datalen, __u8 type);
int jffs2_do_change_meta(struct jffs2_sb_info *c, struct jffs2_inode_info *f, struct jffs2_raw_inode *ri,
					const char *data, int datalen);
int jffs2_do_unlink(struct jffs2_sb_info *c, struct jffs2_inode_info *dir_f, const char *name,
		    int namelen, struct jffs2_inode_info *dead_f, uint32_t time, os_time_t *dir_mtime, os_time_t *dir_ctime, os_time_t *dir_atime);
...
void jffs2_free_sb_info(struct jffs2_sb_info *x);
...
int jffs2_read_dnode(struct jffs2_sb_info *c, struct jffs2_inode_info *f,
		     struct jffs2_full_dnode *fd, char *buf,
		     int ofs, int len);
int jffs2_read_inode_range(struct jffs2_sb_info *c, struct jffs2_inode_info *f,
			   char *buf, uint32_t offset, uint32_t len);
...
/* other */
os_inode_t jffs2_ilookup(os_superblock_t sb, uint32_t inum);
os_inode_t jffs2_iget(os_superblock_t sb, uint32_t inum);
